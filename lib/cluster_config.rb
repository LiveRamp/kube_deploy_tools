...
DEFAULT_FLAGS = {
  ...
  'image_registry' => REGISTRIES['aws']['prefix'],
...
REGISTRIES = {
  'aws' => {
    'prefix' => '***REMOVED***',
    'push' => true,
    'push_auth' => 'aws ecr get-login --no-include-email --region us-west-2',
    'push_auth_returns_docker_command' => true,
  },
  'local' => {
...
CLUSTERS = {
  ...
  'gcp' => {
    'prod' => {
      ...
      'flags' => {
        'cloud' => 'gcp',
        'image_registry' => REGISTRIES['gcp']['prefix'],
        'kubernetes_major_version' => '1',
